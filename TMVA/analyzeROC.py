...
hAUC2D_DNN= TH2D("hAUC2D_DNN", "hAUC2D_DNN;Number of nodes;Number of Layers", len(dnnFtns)*len(dnnNodes), 0, len(dnnFtns)*len(dnnNodes), 30, 1, 31)
hAUC2D_Keras= TH2D("hAUC2D_Keras", "hAUC2D_Keras;Number of nodes;Number of Layers", len(dnnFtns)*len(dnnNodes), 0, len(dnnFtns)*len(dnnNodes), 30, 1, 31)
...
cAUC.cd()
hAUC.SetMinimum(0.72)
hAUC.SetMaximum(0.75)
hAUC.Draw()
...
for c in [cROC, cAUC, cBkgAtWP, cAUC2D_DNN, cAUC2D_Keras]:
    c.Modified()
    c.Update()
