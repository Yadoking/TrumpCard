...
#ifndef AnalyzeM3HYTuple_h
#define AnalyzeM3HYTuple_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   AnalyzeM3HYTuple(TTree *tree=0);
   virtual ~AnalyzeM3HYTuple();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(const std::string modeStr, const std::string outFileName, const std::string algoTypeName);
...
AnalyzeM3HYTuple::~AnalyzeM3HYTuple()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AnalyzeM3HYTuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalyzeM3HYTuple::LoadTree(Long64_t entry)
{
...
void AnalyzeM3HYTuple::Init(TTree *tree)
{
...
Bool_t AnalyzeM3HYTuple::Notify()
{
...
void AnalyzeM3HYTuple::Show(Long64_t entry)
{
...
Int_t AnalyzeM3HYTuple::Cut(Long64_t entry)
{
...
#endif // #ifdef AnalyzeM3HYTuple_cxx
